...
export const metadata: Metadata = {
  ...
  description: "Pengiriman via udara untuk kebutuhan yang memerlukan kecepatan dan ketepatan waktu.",
};
    ...
    <>
      <section className="pt-32 pb-20" style={{background: "var(--primary-dark)"}}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Image src="/icons/air.png" alt="Door to Door Import" width={100} height={100} />
          </div>
          <h1 className="text-4xl md:text-5xl font-black text-white mb-5">Air Freight Service</h1>
          <p className="text-blue-200 text-lg max-w-2xl mx-auto">Pengiriman via udara untuk kebutuhan yang memerlukan kecepatan dan ketepatan waktu.</p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose max-w-none">
            <div className="p-8 rounded-3xl mb-10" style={{background: "var(--bg-light)"}}>
              ...
              <p className="text-gray-600 leading-relaxed">Pengiriman via udara untuk kebutuhan yang memerlukan kecepatan dan ketepatan waktu. PT. Andara Megah Logistik hadir dengan solusi profesional dan tim berpengalaman untuk memastikan setiap pengiriman berjalan lancar.</p>
            </div>
